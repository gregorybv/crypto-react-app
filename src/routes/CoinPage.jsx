  ...
  return (
    <div className='rounded-div my-12 py-8'>
        ...
        <div>
          <div className='flex justify-between'>
            {coin.market_data?.current_price ? (
              // toLocaleString() returns a string with language-dependent date representation
        ...
        <div>
          ...
          <div className='flex justify-between py-4'>
            <div>
              ...
              {coin.market_data ? (
                // toFixed() formats the number using a fixed-point notation
                <p>
      ...
      <div className='py-4'>
        ...
        {/* DOMPurify.sanitize is a powerful tool used for sanitizing user input in web applications. */}
        <p
